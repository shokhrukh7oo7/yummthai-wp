			...
			<div class="row">
				<div class="col-md-6">
					<a class="item-top" href="#">
						<div class="img">
							<img src="<?php echo get_template_directory_uri() . '/assets/img/item-top.jpg'?>" alt="image" />
						</div>
						<div class="desc">
							<h6>
				...
				<div class="swiper">
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<a href="#">
								<img src="<?php echo get_template_directory_uri() . '/assets/img/item.jpg'?>" alt="image" />
							</a>
						</div>
						<div class="swiper-slide">
							<a href="#"> <img src="<?php echo get_template_directory_uri() . '/assets/img/item.jpg'?>" alt="image" /> </a>
						</div>
						<div class="swiper-slide">
							<a href="#"><img src="<?php echo get_template_directory_uri() . '/assets/img/item.jpg'?>" alt="image" /> </a>
						</div>
				...
				<a href="#" class="desc">
					...
					<div class="bottom">
						...
						<div class="desc-item">
							<p>
								<i>
									<img src="<?php echo get_template_directory_uri() . '/assets/img/star.svg'?>" alt="image">
								</i>
								4.86
							</p>
						</div>
